    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2009, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Organized work social by the team", "Work Social" },
                    { 2, 1, new DateTime(2009, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "Organized Breakfast", "Morning Social" }
                });

            migrationBuilder.InsertData(
                table: "Sponsors",
                columns: new[] { "SponsorID", "Amount", "Company", "Email", "EventID", "Surname", "name" },
                values: new object[] { 1, 399.22000000000003, "Striker Investments", "strikerproducts@gmail.com", 17, "Heuston", "Bryan" });
