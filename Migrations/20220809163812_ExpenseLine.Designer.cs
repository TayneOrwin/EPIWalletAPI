...
namespace EPIWalletAPI.Migrations
{
    ...
    [Migration("20220809163812_ExpenseLine")]
    partial class ExpenseLine
    {
            ...
            modelBuilder.Entity("EPIWalletAPI.Models.Entities.ExpenseLine", b =>
                {
                    ...
                    b.Property<int?>("ExpenseRequestExpenseID")
                        .HasColumnType("int");

                    b.HasKey("ExpenseLineID");

                    b.HasIndex("ExpenseRequestExpenseID");
            ...
            modelBuilder.Entity("EPIWalletAPI.Models.Entities.ExpenseLine", b =>
                {
                    b.HasOne("EPIWalletAPI.Models.ExpenseRequest", "ExpenseRequest")
                        .WithMany()
                        .HasForeignKey("ExpenseRequestExpenseID");
